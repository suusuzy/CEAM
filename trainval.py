...
def get_parser():
    ...
    parser.add_argument('--test_set', default='zara2', type=str,
    ...
    parser.add_argument('--save_base_dir', default='./CEAMcombinedloss-REPEAT/', help='Directory for saving caches and models.')
    ...
    parser.add_argument('--load_model', default=None, type=str, help="load pretrained model for test or training,default=None")
